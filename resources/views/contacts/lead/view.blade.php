@can('show', $_lead)
    <div class="panel panel-success lead-panel" data-id="{{$_lead->id}}">
        <div class="panel-heading panel-title">
			<a role="button" data-toggle="collapse" href="#collapseLeadInfo{{$_lead->id}}" aria-expanded="true">
				<i class="fa fa-chevron-down"></i> Договор №{{$_lead->number or null}} - {{$_lead->status->name or null}} {{$_lead->name or null}}</a>
            @can('delete', $_lead)
		...
		<div id="collapseLeadInfo{{$_lead->id}}" class="panel-collapse collapse" role="tabpanel">
